	...
	TextLabel_3.Text = "GG HUB | BF : Free"
...
ImageButton.Image = "https://web.roblox.com/library/10398887347/DOG"
ImageButton.MouseButton1Down:connect(function()
game.CoreGui:FindFirstChild("GGUi").Enabled = not game.CoreGui:FindFirstChild("GGUi").Enabled
end)
--9849581539
